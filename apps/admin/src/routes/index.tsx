			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<div className="rounded-lg border border-zinc-800 p-5">
					...
					<div className="space-y-3 text-sm text-zinc-400">
						<Step n={1}>
							<Link to="/collections" className="text-white hover:underline">
								Create a collection
							</Link>{' '}
						...
						<Step n={3}>
							<Link to="/content/$id" params={{ id: 'new' }} className="text-white hover:underline">
								Create content
							</Link>{' '}
							manually or via MCP
						</Step>
					...
					<div className="mt-6 pt-4 border-t border-zinc-800">
						...
						<pre className="text-xs bg-zinc-900 p-3 rounded overflow-x-auto text-zinc-500">
{`{
  "mcpServers": {
    "innolope": {
      "command": "npx",

	...
	return (
		<div className={`relative ${className}`} ref={ref}>
			<button
				...
				className="w-full flex items-center justify-between px-3 py-2 bg-input border border-border-strong rounded text-sm text-text focus:outline-none focus:border-border-strong text-left"
			>
